...
<figure class="text--center">
  ![](/img/Cortex/inverted-index.png)
  <figcaption>A simplified version of the inverted index.</figcaption>
</figure>
...
<figure class="text--center">
  ![](/img/Cortex/tokenization.png)
  <figcaption>The process of tokenization with an additional stopwords removal and converstion to root form of a word.</figcaption>
</figure>
...
<figure class="text--center">
  ![](/img/Cortex/query.png)
  <figcaption>An example of a query vectorized to sparse format.</figcaption>
</figure>
...
<figure class="text--center">
  ![](/img/Cortex/babel.jpg)
  <figcaption>The Tower of Babel, Pieter Bruegel.</figcaption>
</figure>
...
![deep neural](/img/Cortex/deep-neural.png)
...
<figure class="text--center">
  ![](/img/Cortex/input.png)
  <figcaption>Input queries contain different words, but they are still converted into similar vector representations, because the neural encoder can capture the meaning of the sentences. That feature can capture synonyms but also different languages.</figcaption>
</figure>
