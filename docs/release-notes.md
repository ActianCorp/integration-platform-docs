...
| New Feature | IP-7283 | Timestamp ZoneOffset for [log file API](../../../job-execution#tag/Job/operation/getJobLog) | 3.3.0 |  | Completed |
...
| New&nbsp;Feature | IP-4824 | [Macro API](../../../job-configuration#tag/Job-Config-Macros/operation/createJobConfigMacroFromFile) accepting a file as body to store as value | 3.2.0 |  | Completed |
...
| Issue Type | <div style={{width: 65}}>Issue Key</div> | Summary | Fix versions | Affects versions | Status |
|:---|:---|:---|:---|:---|:---|
| New Feature | IP-622 | [Macrosets API](../../../integration-components#tag/MacroSets) to import, add, modify, export, and delete macrosets. | 3.1.3 |  | Completed |
| New Feature | IP-6231 | [Job Config Tag API](../../../job-configuration#tag/Job-Config-Tags). Provides means to set tags in a JobConfiguration which are then copied to the Jobs created from the configuration, and to list runs for a given integration by specifying tags in query parameters. | 3.1.3 |  | Completed |
| New Feature | IP-6516 | DataConnect 12.1.0-38 Engine | 3.1.3 |  | Completed |
| New Feature | IP-6587 | [Job Config Package API](../../../job-execution#tag/Job/operation/getJobPackage). Provides ability to download the .sqlite or .djar file for a given job run ID. | 3.1.3 |  | Completed |
