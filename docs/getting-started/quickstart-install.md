...
The `application.properties` file can be used for a variety of configurations to tailor Integration Manager to your requirements and environment. See [Application Property Reference](../integration-manager/admin/application-property-reference/properties-overview) for a description of available properties.
