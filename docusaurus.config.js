  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          {to: 'docs/dataconnect/intro-DC', label: 'DataConnect', position: 'left'},
          {to: 'docs/integration-manager/intro-IM', label: 'Integration Manager', position: 'left'},
          {
            label: 'API',
            position: 'left',
            items: [
        ...
        links: [
          {
            html: `
                ...
                <span style="color: black; font-size:10pt;">Copyright © 2025 Actian Corporation. All rights reserved.</span> <a href="./docs/copyright" style="color:blue; font-size:10pt;text-decoration:underline;">Copyright Information</a>
              `,
          },
        ],  
