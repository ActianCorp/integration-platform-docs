    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/ActianCorp/integration-platform-docs/tree/main/',
            ...
            items: [
              {
                html: `
                    ...
                    <div class="footerColumn-right">
                      ...
                      &nbsp;
                      <a href="https://github.com/ActianCorp/integration-platform-docs/tree/gh-pages" target="_blank">
