    ...
    ({
      ...
      footer: {
        ...
        links: [
          {
            html: `
                <a href="http://www.linkedin.com/company/actian-corporation" target="_blank" rel="noreferrer noopener" aria-label="Linkedin" style="margin-right: 8px;">
                ...
                <a href="https://www.facebook.com/actiancorp" target="_blank" style="margin-right: 8px;" style="margin-right: 8px;">
                ...
                <a href="https://twitter.com/actiancorp" target="_blank" style="margin-right: 8px;" style="margin-right: 8px;">
                ...
                <a href="http://www.youtube.com/actiancorporation" target="_blank" style="margin-right: 8px;" style="margin-right: 8px;">
                ...
                <a href="https://github.com/ActianCorp/integration-platform-docs/tree/suggestions" target="_blank" style="margin-right: 24px;">
                ...
                <span style="color:black;font-size:12px; vertical-align:top;text-decoration:none;margin-left:24px;">Copyright © 2026 Actian Corporation. All rights reserved.</span>
                <a href="docs/copyright" style="font-size:12px; vertical-align:top;margin-right:48px;">
